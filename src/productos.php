...
<div class="row">
        <div class="col-md-12">
                        <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#divProductosPaso" aria-expanded="false" aria-controls="divProductosPaso"><i class="fa fa-share mr-2 fa-2x"></i>Transferir Productos</button>
...
<div class="collapse multi-collapse show " id="divProductos">
...
<div class="collapse multi-collapse" id="divProductosPaso">
